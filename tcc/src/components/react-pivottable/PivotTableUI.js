...
var _SortableWrapper = require('./SortableWrapper');

var _reactSortablejs2 = _interopRequireDefault(_SortableWrapper);
...
var DraggableAttribute = (exports.DraggableAttribute = (function (_React$Component) {
  ...
  function DraggableAttribute(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (DraggableAttribute.__proto__ || Object.getPrototypeOf(DraggableAttribute)).call(this, props),
    );

    _this.state = { open: false, filterText: '' };
    _this.draggableRef = _react2.default.createRef();
    return _this;
  }
    ...
    },
    {
      ...
      value: function selectOnly(e, value) {
        ...
        this.props.setValuesInFilter(
          this.props.name,
          Object.keys(this.props.attrValues).filter(function (y) {
            return y !== value;
          }),
        );
      },
    },
    {
      ...
      value: function getFilterBox() {
        ...
        return _react2.default.createElement(
          ...
          { handle: '.pvtDragHandle', nodeRef: this.draggableRef },
          _react2.default.createElement(
            ...
            _react2.default.createElement('span', { className: 'pvtDragHandle' }, '\u2630'),
            _react2.default.createElement('h4', null, this.props.name),
            showMenu || _react2.default.createElement('p', null, '(too many values to show)'),
            showMenu &&
              _react2.default.createElement(
                'p',
                null,
                ...
                _react2.default.createElement(
                  'a',
                  {
                    ...
                    className: 'pvtButton',
                    onClick: function onClick() {
                      return _this2.props.removeValuesFromFilter(
                        _this2.props.name,
                        Object.keys(_this2.props.attrValues).filter(
                          _this2.matchesFilter.bind(_this2),
                        ),
                      );
                    },
                  },
                ...
                _react2.default.createElement(
                  'a',
                  {
                    ...
                    className: 'pvtButton',
                    onClick: function onClick() {
                      return _this2.props.addValuesToFilter(
                        _this2.props.name,
                        Object.keys(_this2.props.attrValues).filter(
                          _this2.matchesFilter.bind(_this2),
                        ),
              ...
              _react2.default.createElement(
                ...
                shown.map(function (x) {
                  return _react2.default.createElement(
                    ...
                    _react2.default.createElement('a', { className: 'pvtOnlySpacer' }, '\xA0'),
                    x === '' ? _react2.default.createElement('em', null, 'null') : x,
                  );
                }),
              ),
          ),
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.props.current || _react2.default.createElement('span', null, '\xA0'),
          ),
          this.props.open &&
            _react2.default.createElement(
              'div',
              ...
              this.props.values.map(function (r) {
                return _react2.default.createElement(
                  'div',
                  {
                    ...
                    className:
                      'pvtDropdownValue ' +
                      (r === _this4.props.current ? 'pvtDropdownActiveValue' : ''),
                  },
                  r,
                );
              }),
...
var PivotTableUI = (function (_React$PureComponent2) {
  ...
  function PivotTableUI(props) {
    ...
    var _this5 = _possibleConstructorReturn(
      this,
      (PivotTableUI.__proto__ || Object.getPrototypeOf(PivotTableUI)).call(this, props),
    );
  ...
  _createClass(PivotTableUI, [
    ...
    },
    {
      ...
      value: function materializeInput(nextData) {
        ...
        _Utilities.PivotData.forEachRecord(
          newState.data,
    ...
    },
    {
      ...
      value: function addValuesToFilter(attribute, values) {
        if (attribute in this.props.valueFilter) {
          this.sendPropUpdate({
            valueFilter: _defineProperty(
              {},
              attribute,
              values.reduce(function (r, v) {
                r[v] = { $set: true };
                return r;
              }, {}),
            ),
    ...
    },
    {
      ...
      value: function moveFilterBoxToTop(attribute) {
        this.setState(
          (0, _immutabilityHelper2.default)(this.state, {
    ...
    },
    {
      ...
      value: function render() {
            ...
            return [
              _react2.default.createElement(Dropdown, {
                ...
                values: Object.keys(_this8.state.attrValues).filter(function (e) {
                  return (
                    !_this8.props.hiddenAttributes.includes(e) &&
                    !_this8.props.hiddenFromAggregators.includes(e)
                  );
                }),
              ...
              i + 1 !== numValsAllowed
                ? _react2.default.createElement('br', { key: 'br' + i })
                : null,
            ];
          }),
        ...
        var unusedAttrs = Object.keys(this.state.attrValues)
          .filter(function (e) {
            return (
              !_this8.props.rows.includes(e) &&
              !_this8.props.cols.includes(e) &&
              !_this8.props.hiddenAttributes.includes(e) &&
              !_this8.props.hiddenFromDragDrop.includes(e)
            );
          })
        ...
        var unusedAttrsCell = this.makeDnDCell(
          unusedAttrs,
          function (order) {
        ...
        var colAttrsCell = this.makeDnDCell(
          colAttrs,
        ...
        var rowAttrsCell = this.makeDnDCell(
          rowAttrs,
        ...
        var outputCell = _react2.default.createElement(
          ...
          { className: 'pvtOutput' },
          _react2.default.createElement(
            _PivotTable2.default,
            (0, _immutabilityHelper2.default)(this.props, {
        ...
        if (horizUnused) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('tr', null, rendererCell, unusedAttrsCell),
              _react2.default.createElement('tr', null, aggregatorCell, colAttrsCell),
              _react2.default.createElement('tr', null, rowAttrsCell, outputCell),
            ),
          );
        }
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('tr', null, rendererCell, aggregatorCell, colAttrsCell),
            _react2.default.createElement('tr', null, unusedAttrsCell, rowAttrsCell, outputCell),
          ),
        );
      },
    },
