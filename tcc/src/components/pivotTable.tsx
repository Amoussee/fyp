                ...
                <div className="overflow-auto max-h-full w-full border rounded-lg shadow-sm">
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Option</th>
                                <th className="px-4 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">Count</th>
                                <th className="px-4 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">Freq (%)</th>
                            </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
                            {chartData.map((row, idx) => (
                                <tr key={idx} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-4 py-3 text-sm text-gray-600 text-right font-mono tabular-nums">{row.total}</td>
                        ...
                        {chartData.length > 1 && (
                            <tfoot className="bg-gray-50 font-bold border-t-2">
                                <tr>
                                    ...
                                    <td className="px-4 py-2 text-sm text-gray-900 text-right font-mono tabular-nums">{totalCount}</td>
                                    <td className="px-4 py-2 text-sm text-gray-900 text-right font-mono tabular-nums">100.0%</td>
                                </tr>
                            </tfoot>
                        )}
                    </table>
