...
const CreateDashboardModal = ({ isOpen, onClose, onCreate }: CreateDashboardModalProps) => {
    ...
    const renderLayoutOption = (type: DashboardLayoutType, title: string, description: string, visual: React.ReactNode) => (
        <div 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white p-8 rounded-2xl w-[800px] shadow-2xl scale-100 animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-8">
                        <label className="block text-sm font-semibold text-gray-700 mb-4">Select Grid Layout</label>
                        <div className="grid grid-cols-4 gap-4">
                            {/* Layout 1 */}
                            {renderLayoutOption('layout-1', 'Single Focus', '1 Big Chart', (
                                <div className="w-full h-full bg-gray-300 rounded border border-gray-400"></div>
                            ))}
                            
                            {/* Layout 2 */}
                            {renderLayoutOption('layout-2', 'Split View', '2 Charts', (
                            ...
                            {/* Layout 3 */}
                            {renderLayoutOption('layout-3', 'Three Column', '3 Charts', (
                            ...
                            {/* Layout 4 */}
                            {renderLayoutOption('layout-4', 'Quad Grid', '4 Charts (2x2)', (
